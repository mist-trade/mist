...
import type { DuanChannelVo } from './vo/duan-channel.vo';
...
export function toDuanChannelVo(channel: ChanDuanChannel): DuanChannelVo {
  return {
    duans: channel.duans.map(toDuanVo),
    zg: channel.zg,
    zd: channel.zd,
    gg: channel.gg,
    dd: channel.dd,
