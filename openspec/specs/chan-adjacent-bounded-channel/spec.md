# chan-adjacent-bounded-channel Specification

## Purpose
Define parent-level macro stroke interval partitioning for sub-level Chan central computation, ensuring that sub-level centrals are strictly endogenous to macro strokes without crossing major extrema boundaries or tearing across top/bottom reversals.
