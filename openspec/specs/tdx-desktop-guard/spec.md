# tdx-desktop-guard Specification

## Purpose
Defines the private Windows operations boundary for TDX desktop guard
automation in `mist-deploy`, including its separation from ordinary Docker
deployment and normal datasource service management.
