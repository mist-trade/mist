# chan-central-lifecycle Specification

## Purpose
Define the lifecycle, geometry boundaries, and trend-structure preservation rules for Chan central formation and extension at Bi-level and Duan-level.
